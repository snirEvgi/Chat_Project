...
const initialReviews = [
  {
    ...
    image:
      "https://media.istockphoto.com/id/468382096/photo/scottish-fold-shorthair-cat-resting-on-chair.jpg?s=612x612&w=0&k=20&c=h4wd1YM47fJgJwi9B-HnFxaFYE1M1WUB-d7atkH7mG8=",
  },
  {
    author: "Yuval Chen",
    rating: 4,
  ...
  },
  {
    ...
    image:
      "https://media.istockphoto.com/id/537406958/photo/max-brenner.jpg?s=612x612&w=0&k=20&c=aqutOseyz64rojpc2407FYFI41_k2rJ9oFQ6NuK-iWw=",
  },
]
...
const HomePage = () => {
  ...
  const [chats, setChats] = useState<Array<any>>([
    { chatId: 1, firstUserId: 1, secondUserId: 2 },
  ])
